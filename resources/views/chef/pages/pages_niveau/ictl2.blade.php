@extends('base_chef')
@section('title', 'ICT FOLLOW UP | ICTL2')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">ICTL2</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('welcome') }}">Accueil</a></li>
                            <li class="breadcrumb-item active">ICT-L2</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div id="jsGrid1">
                        <div class="container">
                            <table class="table">
                                ...
                                <tbody>
                                @forelse ($coursSemestre1 as $coursS1l2)
                                    <tr>
                                        <td>{{ $coursS1l2->id }}</td>
                                        ...
                                        <td>
                                            <form action="{{ route('ictl1', $coursS1l2->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div id="jsGrid1">
                        <div class="container">
                            <table class="table">
                                ...
                                <tbody>
                                @forelse ($coursSemestre2 as $coursS2l2)
                                    <tr>
                                        <td>{{ $coursS2l2->id }}</td>
                                        ...
                                        <td>
                                            <form action="{{ route('ue_l2.destroy', $coursS2l2->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger">Supprimer</button>
                                            </form>
